...
https://osf.io/preprints/socarxiv/4w9af/ "Power to Persuade"){target="_blank"}" (with [Carlo Prato](https://sites.google.com/site/carloprato1982/carlo-prato "Carlo Prato"){target="_blank"}).\
<details>
<summary>*Abstract*</summary>
...
* "Dark Money and Politician Learning" (with [Keith E. Schnakenberg](http://keith-schnakenberg.com/ "Keith Schnakenberg"){target="_blank"}).\
<details>
<summary>*Abstract*</summary>
We study the consequences of campaign finance disclosure laws in a model of informative campaign finance. Campaign spending can affect electoral outcomes and also signal policy information to politicians. Under mandatory disclosure donors may engage in spending that runs counter to their electoral interests in order to signal good news regarding their preferred policy. When donors can use dark money the electoral price to influence increases to account for the possibility that donors use public contributions to signal but secretly offset the electoral costs with dark money. We provide empirical implications across campaign disclosure regimes. For example, we show that observable contributions to moderate candidates will tend to increase when dark money is allowed. We also discuss how internal organizational pressure and the threat of social sanctions or political contributions affect patterns of campaign spending, both within and across disclosure environments.
...
* "Legislative Particularism and Bureaucratic Policymaking" (with [John W. Patty](http://www.johnwpatty.net/ "John Patty"){target="_blank"}).\
<details>
<summary>*Abstract*</summary>
